...
!(function (t, e) {
  ...
  function ft(t) {
    return t instanceof ct(t).phpElement || t instanceof HTMLElement;
  }
  var dt = {
    name: "applyStyles",
    enabled: !0,
        ...
        (r.setElementContent = function (t, e) {
          if (null !== t)
            return "object" == typeof e && d(e)
              ? (e.jquery && (e = e[0]), void (this.config.php ? e.parentNode !== t && ((t.innerHTML = ""), t.appendChild(e)) : (t.textContent = e.textContent)))
              : void (this.config.php ? (this.config.sanitize && (e = ke(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
        }),
        (r.getTitle = function () {

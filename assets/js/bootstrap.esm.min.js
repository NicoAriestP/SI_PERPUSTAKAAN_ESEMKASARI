...
function bootstrapDelegationHandler(e, t, n) {
  return function i(o) {
    for (var r = e.querySelectorAll(t), s = o.target; s && s !== this; s = s.parentNode) for (var a = r.length; a--; ) if (r[a] === s) return (o.delegateTarget = s), i.oneOff && EventHandler.off(e, o.type, n), n.apply(s, [o]);
    return null;
  };
}
...
var EventHandler = {
    ...
    trigger: function (e, t, n) {
      ...
      var i,
        ...
        c = null;
      return (
        s && o && ((i = o.Event(t, n)), o(e).trigger(i), (l = !i.isPropagationStopped()), (E = !i.isImmediatePropagationStopped()), (_ = i.isDefaultPrevented())),
        a ? (c = document.createEvent("HTMLEvents")).initEvent(r, l, !0) : (c = new CustomEvent(t, { bubbles: l, cancelable: !0 })),
        void 0 !== n &&
...
var Manipulator = {
  ...
  SelectorEngine = {
    ...
    parents: function (e, t) {
      for (var n = [], i = e.parentNode; i && i.nodeType === Node.ELEMENT_NODE && i.nodeType !== NODE_TEXT; ) i.matches(t) && n.push(i), (i = i.parentNode);
      return n;
    },
    prev: function (e, t) {
  ...
  Carousel = (function (e) {
    ...
    return (
      ...
      (n._addTouchEventListeners = function () {
        var e = this,
          t = function (t) {
            !e._pointerEvent || (t.pointerType !== POINTER_TYPE_PEN && t.pointerType !== POINTER_TYPE_TOUCH) ? e._pointerEvent || (e.touchStartX = t.touches[0].clientX) : (e.touchStartX = t.clientX);
          },
          n = function (t) {
            !e._pointerEvent || (t.pointerType !== POINTER_TYPE_PEN && t.pointerType !== POINTER_TYPE_TOUCH) || (e.touchDeltaX = t.clientX - e.touchStartX),
              e._handleSwipe(),
          ...
          if (((this._isSliding = !0), a && this.pause(), this._setActiveIndicatorElement(r), (this._activeElement = r), this._element.classList.contains(CLASS_NAME_SLIDE))) {
            ...
            EventHandler.one(i, "transitionend", function () {
              r.classList.remove(l, E),
                ...
                (n._isSliding = !1),
                setTimeout(function () {
                  EventHandler.trigger(n._element, EVENT_SLID, { relatedTarget: r, direction: _, from: o, to: s });
                }, 0);
            }),
              emulateTransitionEnd(i, c);
          } else i.classList.remove(CLASS_NAME_ACTIVE$1), r.classList.add(CLASS_NAME_ACTIVE$1), (this._isSliding = !1), EventHandler.trigger(this._element, EVENT_SLID, { relatedTarget: r, direction: _, from: o, to: s });
          a && this.cycle();
        }
      }),
...
EventHandler.on(document, EVENT_CLICK_DATA_API$2, SELECTOR_DATA_SLIDE, Carousel.dataApiClickHandler),
  EventHandler.on(window, EVENT_LOAD_DATA_API, function () {
    for (var e = SelectorEngine.find(SELECTOR_DATA_RIDE), t = 0, n = e.length; t < n; t++) Carousel.carouselInterface(e[t], Data.getData(e[t], DATA_KEY$2));
  }),
  ...
  Collapse = (function (e) {
    function t(t, n) {
      ...
      ((i = e.call(this, t) || this)._isTransitioning = !1),
        (i._config = i._getConfig(n)),
        (i._triggerArray = SelectorEngine.find(SELECTOR_DATA_TOGGLE$1 + '[href="#' + t.id + '"],' + SELECTOR_DATA_TOGGLE$1 + '[data-bs-target="#' + t.id + '"]'));
...
var NAME$4 = "dropdown",
  ...
  Default$2 = { offset: [0, 2], flip: !0, boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null },
  DefaultType$2 = { offset: "(array|string|function)", flip: "boolean", boundary: "(string|element)", reference: "(string|element|object)", display: "string", popperConfig: "(null|object|function)" },
  Dropdown = (function (e) {
    function t(t, n) {
      var i;
    ...
    return (
          ...
          if (!EventHandler.trigger(this._element, EVENT_SHOW$1, n).defaultPrevented) {
            if (this._inNavbar) Manipulator.setDataAttribute(this._menu, "popper", "none");
              ...
              "parent" === this._config.reference
                ...
                ? ((i = this._config.reference), void 0 !== this._config.reference.jquery && (i = this._config.reference[0]))
              ...
              (this._popper = createPopper(i, this._menu, o)), r && Manipulator.setDataAttribute(this._menu, "popper", "static");
            }
            var s;
      ...
      (n._getConfig = function (e) {
        if (
          ((e = _extends({}, this.constructor.Default, Manipulator.getDataAttributes(this._element), e)),
      ...
      (n._getPopperConfig = function () {
        ...
        return "static" === this._config.display && (e.modifiers = [{ name: "applyStyles", enabled: !1 }]), _extends({}, e, "function" == typeof this._config.popperConfig ? this._config.popperConfig(e) : this._config.popperConfig);
      }),
      ...
      (t.clearMenus = function (e) {
        if (!e || (e.button !== RIGHT_MOUSE_BUTTON && ("keyup" !== e.type || e.key === TAB_KEY)))
          for (var t = SelectorEngine.find(SELECTOR_DATA_TOGGLE$2), n = 0, i = t.length; n < i; n++) {
            ...
            if ((e && "click" === e.type && (r.clickEvent = e), o)) {
              ...
              if (
                ...
                !((e && (("click" === e.type && /input|textarea/i.test(e.target.tagName)) || ("keyup" === e.type && e.key === TAB_KEY)) && a.contains(e.target)) || EventHandler.trigger(t[n], EVENT_HIDE$1, r).defaultPrevented)
              )
                "ontouchstart" in document.documentElement &&
                  (s = []).concat.apply(s, document.body.children).forEach(function (e) {
      ...
      (t.dataApiKeydownHandler = function (e) {
        if (
          !(/input|textarea/i.test(e.target.tagName) ? e.key === SPACE_KEY || (e.key !== ESCAPE_KEY && ((e.key !== ARROW_DOWN_KEY && e.key !== ARROW_UP_KEY) || e.target.closest(SELECTOR_MENU))) : !REGEXP_KEYDOWN.test(e.key)) &&
          (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains(CLASS_NAME_DISABLED))
        ) {
  ...
  Modal = (function (e) {
    ...
    return (
      ...
      (n.show = function (e) {
        ...
        if (!this._isShown && !this._isTransitioning) {
          ...
          this._isShown ||
            ...
            EventHandler.on(this._element, EVENT_CLICK_DISMISS, SELECTOR_DATA_DISMISS, function (e) {
              return t.hide(e);
            }),
      ...
      (n._showElement = function (e) {
        ...
        var o = function () {
          t._config.focus && t._element.focus(), (t._isTransitioning = !1), EventHandler.trigger(t._element, EVENT_SHOWN$2, { relatedTarget: e });
        };
        if (n) {
      ...
      (n._adjustDialog = function () {
        ...
        ((!this._isBodyOverflowing && e && !isRTL) || (this._isBodyOverflowing && !e && isRTL)) && (this._element.style.paddingLeft = this._scrollbarWidth + "px"),
          ((this._isBodyOverflowing && !e && !isRTL) || (!this._isBodyOverflowing && e && isRTL)) && (this._element.style.paddingRight = this._scrollbarWidth + "px");
      }),
  ...
  Tooltip = (function (e) {
    ...
    return (
      ...
      (n.setElementContent = function (e, t) {
        if (null !== e)
          return "object" == typeof t && isElement(t)
            ? (t.jquery && (t = t[0]), void (this.config.php ? t.parentNode !== e && ((e.innerHTML = ""), e.appendChild(t)) : (e.textContent = t.textContent)))
            : void (this.config.php ? (this.config.sanitize && (t = sanitizeHtml(t, this.config.allowList, this.config.sanitizeFn)), (e.innerHTML = t)) : (e.textContent = t));
      }),
      (n.getTitle = function () {
      ...
      (n._fixTitle = function () {
        ...
        (e || "string" !== t) &&
          (this._element.setAttribute("data-bs-original-title", e || ""), !e || this._element.getAttribute("aria-label") || this._element.textContent || this._element.setAttribute("aria-label", e), this._element.setAttribute("title", ""));
      }),
      (n._enter = function (e, t) {
        (t = this._initializeOnDelegatedTarget(e, t)),
          e && (t._activeTrigger["focusin" === e.type ? TRIGGER_FOCUS : TRIGGER_HOVER] = !0),
          t.getTipElement().classList.contains(CLASS_NAME_SHOW$4) || t._hoverState === HOVER_STATE_SHOW
      ...
      (n._getConfig = function (e) {
        ...
        return (
          ...
          "number" == typeof (e = _extends({}, this.constructor.Default, t, "object" == typeof e && e ? e : {})).delay && (e.delay = { show: e.delay, hide: e.delay }),
  ...
  ScrollSpy = (function (e) {
    function t(t, n) {
      ...
      return (
        ...
        (i._config = i._getConfig(n)),
        (i._selector = i._config.target + " " + SELECTOR_NAV_LINKS + ", " + i._config.target + " " + SELECTOR_LIST_ITEMS + ", " + i._config.target + " ." + CLASS_NAME_DROPDOWN_ITEM),
        (i._offsets = []),
        (i._targets = []),
    ...
    return (
      ...
      (n._activate = function (e) {
        ...
        n.classList.contains(CLASS_NAME_DROPDOWN_ITEM)
          ? (SelectorEngine.findOne(SELECTOR_DROPDOWN_TOGGLE, n.closest(SELECTOR_DROPDOWN)).classList.add(CLASS_NAME_ACTIVE$2), n.classList.add(CLASS_NAME_ACTIVE$2))
    ...
    return (
      (n.show = function () {
        ...
        if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(CLASS_NAME_ACTIVE$3)) || this._element.classList.contains(CLASS_NAME_DISABLED$1))) {
          ...
          var r = t ? EventHandler.trigger(t, EVENT_HIDE$3, { relatedTarget: this._element }) : null;
          if (!(EventHandler.trigger(this._element, EVENT_SHOW$3, { relatedTarget: t }).defaultPrevented || (null !== r && r.defaultPrevented))) {
            this._activate(this._element, i);
            var s = function () {
              EventHandler.trigger(t, EVENT_HIDDEN$3, { relatedTarget: e._element }), EventHandler.trigger(e._element, EVENT_SHOWN$3, { relatedTarget: t });
            };
...
var NAME$a = "toast",
  ...
  Toast = (function (e) {
    ...
    return (
      ...
      (n.dispose = function () {
        this._clearTimeout(),
          this._element.classList.contains(CLASS_NAME_SHOW$7) && this._element.classList.remove(CLASS_NAME_SHOW$7),
          EventHandler.off(this._element, EVENT_CLICK_DISMISS$1),
          e.prototype.dispose.call(this),
          (this._config = null);
      }),
      (n._getConfig = function (e) {
        return (e = _extends({}, Default$7, Manipulator.getDataAttributes(this._element), "object" == typeof e && e ? e : {})), typeCheckConfig(NAME$a, e, this.constructor.DefaultType), e;
      }),
      (n._setListeners = function () {
        var e = this;

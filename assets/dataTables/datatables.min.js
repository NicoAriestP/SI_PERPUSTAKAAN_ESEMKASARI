...
(function (h) {
  ...
  m.defaults = {
    ...
    oLanguage: {
      ...
      sInfoEmpty: "Menampilkan 0 sampai 0 dari 0 hasil",
      sInfoFiltered: "(filtered from _MAX_ total hasil)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
          ...
          r = function (b, d) {
            ...
            for (t = d.length; k < t; k++) {
              ...
              if (h.isArray(s)) {
                ...
                if (m !== null) {
                  u = h("<a>", { class: g.sPageButton + " " + l, "aria-controls": a.sTableId, "aria-label": i[s], "data-dt-idx": p, tabindex: a.iTabIndex, id: c === 0 && typeof s === "string" ? a.sTableId + "_" + s : null })
                    .html(m)
                    .appendTo(b);
                  Ya(u, { action: s }, v);
                  p++;

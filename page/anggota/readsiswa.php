...
$worksheet              = $spreadsheet->getActiveSheet();
    ...
    $kolom_str                  = array("nis","nama","tempat_lahir","tgl_lahir","jk","kelas");
    // array output
    $hasil                  = array();
    ...
    include '../../config.php';
    foreach($hasil as $h) {
        $sql = $conn->query("INSERT INTO tb_anggota(nis,nama,tempat_lahir
            ,tgl_lahir,jk,kelas) VALUES 
        (".$h['nis'].",\"".$h['nama']."\",\"".$h['tempat_lahir']."\",\"".$h['tgl_lahir']."\",\"".$h['jk']."\",\"".$h['kelas']."\")");
    }
